##' \code{\link{scenario_3_pa}} provides a probability of acceptance  under scenario 2 of modelling the quantity of material sampled in the risk assessment study.
...
##' @details \code{\link{scenario_3_pa}} provides a probability of acceptance  under scenario 2 of modelling the quantity of material sampled in the risk assessment study.
...
##' K <- 0.25
##' n_sim <- 100000
##' scenario_3_pa(c, mu, sd, m, n, K, n_sim)
##' @usage  scenario_3_pa(c, mu, sd, m, n, K, n_sim)
##' @export
scenario_3_pa <- function(c, mu, sd = 0.8, m, n, K, n_sim){
  pd <- scenario_3_pd(mu, sd, m, K, n_sim)
