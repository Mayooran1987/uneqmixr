##' \code{\link{scenario_4_prevalence}} provides a prevalence before inspection under scenario 4 of modelling the quantity of material sampled in the risk assessment study.
##' @title Prevalence estimation before inspection when lot with homogeneous contamination and contamination levels fluctuate from lot to lot.
...
##' @details \code{\link{scenario_1_pd}} provides a prevalence before inspection under scenario 4 of modelling the quantity of material sampled in the risk assessment study. (this section will be updated later on)
##' @return Prevalence estimation before inspection when lot with homogeneous contamination and contamination levels fluctuate from lot to lot by using theoretical or simulation-based results.
##' @examples
##' mu <- -3
##' sd <- 0.8
