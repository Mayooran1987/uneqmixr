##' \code{\link{scenario_1A_pd}} provides a probability of detection under scenario 1 of modelling the quantity of material sampled in the risk assessment study.
...
##' @details \code{\link{scenario_1A_pd}} provides a probability of detection under scenario 1 of modelling the quantity of material sampled in the risk assessment study.
...
##' M <- 60
##' m1 <- 5
##' scenario_1A_pd(lambda, M, m1)
##' @usage  scenario_1A_pd(lambda, M, m1)
##' @export
scenario_1A_pd <- function(lambda, M, m1){
